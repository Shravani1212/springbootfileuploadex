package cgg.springboot.fileupload.springbootfileuploadex.controller;
...
public class FileController {
    ...
    public ResponseEntity<FileResponse>fileUpload(@RequestParam("image") MultipartFile image) {
        ...
        try {
            ...
            //validation
             ...
             if(!image.getContentType().equals("image/jpg")){
                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new FileResponse(image.getOriginalFilename(), "Only JPg content allowed"));
             }
        ...
        return new ResponseEntity<FileResponse>(new FileResponse(fileName, "FIle uploaded succesfuuly"),HttpStatus.OK);
    }
